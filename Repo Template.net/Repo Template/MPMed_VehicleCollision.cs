...

{
    ...
    [CalloutProperties("Military Police Medical Vehicle Collision", "Valandria", "0.0.1")]
    public class MilitaryCarCrash : FivePD.API.Callout
    {
