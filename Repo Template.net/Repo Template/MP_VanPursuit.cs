...
namespace ZancudoMilitaryPolice
{
    ...
    [CalloutProperties("Military Police Pursuit of Surveillance Van", "Valandria", "0.0.1")]
    public class SurveillanceVanPursuit : Callout
    {
        private Vehicle car;
        ...
        public SurveillanceVanPursuit()
        {
            InitInfo(coordinates[RandomUtils.Random.Next(coordinates.Length + 30)]);
            ShortName = "MP - Pursuit of Surveillance Van";
            CalloutDescription = "A surveillance van has been spotted packing up, intercept and recover whatever you can.";
            ResponseCode = 3;
            StartDistance = 200f;
        }
