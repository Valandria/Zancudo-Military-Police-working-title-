...
namespace ZancudoMilitaryPolice
{
    ...
    [CalloutProperties("Military Police Suspicious Boat", "Valandria", "0.0.1")]
    public class SuspiciousBoatOnShore : Callout
    {
        private Vehicle car;
        ...
        public SuspiciousBoatOnShore()
        {
            InitInfo(coordinates[RandomUtils.Random.Next(coordinates.Length + 30)]);
            ShortName = "MP - Suspicious Boat Ashore";
            CalloutDescription = "A suspicious boat has been spotted around the base, investigate and recover whatever you can.";
            ResponseCode = 2;
            StartDistance = 150f;
        }
